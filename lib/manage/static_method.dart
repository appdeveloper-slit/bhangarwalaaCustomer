...
class STM {
  ...
  void successWithNoRedirect(context, message, method) {
    AwesomeDialog(
      ...
      return [
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            "assets/bn_home_black.svg",
            color: index == 0 ? Clr().white : null,
          ),
          label: 'Home',
        ),
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            "assets/bn_myrequest_black.svg",
        ...
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            "assets/Rate List.svg",
            color: index == 2 ? Clr().white : null,
          ),
          label: 'RateList',
        ),
        BottomNavigationBarItem(
